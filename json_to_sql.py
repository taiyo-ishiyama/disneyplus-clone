...
for movie_id, movie in movies.items():
    ...
    type = movie["type"]
    print(f"INSERT INTO movies (backgroundImg, cardImg, description, subTitle, title, titleImg, type) VALUES ('{backgroundImg}', '{cardImg}', '{description}', '{subTitle}', '{title}', '{titleImg}', '{type}');")
